<div align="center">
  ...
  <p align="center">
    ...
    <a href="https://github.com/fahadnokhaizcheema" target="_blank">
...
<h2 align="center">
  ⚙️ Tech Stack &amp; Skills
  <img src="https://raw.githubusercontent.com/ABSphreak/ABSphreak/master/gifs/Hi.gif" width="30" alt="Hi Gif">
</h2>

<!-- 🔄 Animated Skills Accent -->
<div align="center">
  <img src="https://media.giphy.com/media/SS8CV2rQdlYNLtBCiF/giphy.gif" width="200" alt="Loading Skills" />
</div>
...
<div align="center">
  ...
  <h3>💻 Core Web &amp; Frontend 
    <img src="https://media.giphy.com/media/QNFhOolVeCzPQ2Mx85/giphy.gif" width="32" alt="Frontend Gif">
  </h3>
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,react,nextjs,tailwind,bootstrap,sass,redux" alt="Frontend Skills" />

  <h3>🧩 Backend &amp; APIs 
    <img src="https://media.giphy.com/media/j0HjChGV0J44KrrlGv/giphy.gif" width="32" alt="Backend Gif">
  </h3>
  <img src="https://skillicons.dev/icons?i=nodejs,express,fastapi,python,mongodb,postgres,firebase,graphql" alt="Backend Skills" />

  <h3>☁️ Cloud, DevOps &amp; Tools 
    <img src="https://media.giphy.com/media/V4NSR1NG2p0KeJJyr5/giphy.gif" width="32" alt="Cloud Gif">
  </h3>
  <img src="https://skillicons.dev/icons?i=aws,docker,git,github,vercel,postman" alt="Cloud &amp; Tools" />

  <h3>🧠 AI, ML, DL &amp; Data 
    <img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="32" alt="AI Gif">
  </h3>
  <img src="https://skillicons.dev/icons?i=tensorflow,pytorch,opencv" alt="AI &amp; Data" />

</div>

<br/>

<!-- 💥 COLLAPSIBLE DETAILED SKILLS -->
...
<details>
  ...
  <ul>
    ...
    <li>Media Elements: Images, Videos, Audio, Embedded Content (iframes)</li>
    <li>Forms: Input Types, Validation, User-friendly Form Design</li>
    <li><b>CSS Core:</b> Selectors, Specificity, Box Model</li>
    <li>Layouts: Flexbox, CSS Grid, Responsive Layouts</li>
    <li>Media Queries, Mobile-first Responsive Design</li>
    <li>Advanced Styling: Animations, Transitions, Hover Effects</li>
    <li>Frameworks: <b>Bootstrap, Tailwind CSS, Chakra UI</b></li>
  </ul>
</details>
...
<details>
  ...
  <br/>
  <ul>
    <li>Syntax, Variables, Data Types, Functions, Scope, Closures</li>
    ...
    <li>Debugging &amp; Testing (DevTools, basic test flows)</li>
    <li>Google AI Studio &amp; Gemini Integration</li>
    <li>Personalized Chatbots &amp; JS-based AI utilities</li>
    <li>Projects: Weather Apps, YouTube, Spotify, WhatsApp Clones</li>
  </ul>
</details>

<details>
  <summary><b>🌿 Git &amp; GitHub Workflows</b></summary>
  <br/>
  <ul>
    <li>Version Control: git init, add, commit, log, status</li>
    <li>Branching, Merging, Conflict Resolution</li>
    <li>GitHub for hosting &amp; collaboration (PRs, Issues, Projects)</li>
    <li>GitHub Actions for CI/CD</li>
    <li>GitHub Web Client &amp; GitHub Desktop workflows</li>
  </ul>
</details>
...
<details>
  ...
  <br/>
  <ul>
    <li>React Fundamentals: Components, JSX, Props</li>
    <li>State &amp; Lifecycle: Hooks (useState, useEffect, custom hooks)</li>
    <li>Routing &amp; Navigation (React Router)</li>
    <li>Advanced State: Context API, Redux</li>
